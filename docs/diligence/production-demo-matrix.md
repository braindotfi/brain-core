...
| Balance reservations        | Production-ready                           | Ledger-account payments lock the source account, recheck balance net of active reservations, and create reservations atomically with the durable outbox handoff; successful settlement consumes them and deterministic rail failure releases them. x402/escrow are exempt and use on-chain wallet or escrow state. |
