...
export class AuthSiwxInvalidError extends brainErrorClass("auth_siwx_invalid") {}
export class ScopeInsufficientError extends brainErrorClass("scope_insufficient") {}

// Tenant
export class TenantNotFoundError extends brainErrorClass("tenant_not_found") {}
export class TenantSuspendedError extends brainErrorClass("tenant_suspended") {}
export class TenantAccessDeniedError extends brainErrorClass("tenant_access_denied") {}

// Source
export class SourceNotFoundError extends brainErrorClass("source_not_found") {}
export class SourceRateLimitError extends brainErrorClass("source_rate_limit") {}
export class SourceCredentialInvalidError extends brainErrorClass("source_credential_invalid") {}

// Policy
export class PolicyNotActiveError extends brainErrorClass("policy_not_active") {}
...
export class ScopeHashMismatchError extends brainErrorClass("scope_hash_mismatch") {}
...
export class ActionAlreadyExecutedError extends brainErrorClass("action_already_executed") {}
export class InsufficientBalanceError extends brainErrorClass("insufficient_balance") {}
export class LimitsExceededError extends brainErrorClass("limits_exceeded") {}
export class IdempotencyKeyReusedError extends brainErrorClass("idempotency_key_reused") {}

// Pre-execution gate (8 codes)
export class GateNoPolicyDecisionError extends brainErrorClass("gate_no_policy_decision") {}
export class GatePolicyVersionStaleError extends brainErrorClass("gate_policy_version_stale") {}
...
export class GateBalanceInsufficientError extends brainErrorClass("gate_balance_insufficient") {}
export class GateApprovalIncompleteError extends brainErrorClass("gate_approval_incomplete") {}
export class GateSessionKeyInvalidError extends brainErrorClass("gate_session_key_invalid") {}
export class GateAuditChainStaleError extends brainErrorClass("gate_audit_chain_stale") {}

// Validation
export class ValidationFailedError extends brainErrorClass("validation_failed") {}
export class MissingRequiredFieldError extends brainErrorClass("missing_required_field") {}
...
export class UpstreamTimeoutError extends brainErrorClass("upstream_timeout") {}
export class MaintenanceModeError extends brainErrorClass("maintenance_mode") {}
