...
export type RegeneratePageOptions = GetPageOptions;
...
export class WikiModule {
  ...
  public async question(opts: AskOptions): Promise<WikiAnswer> {
    return this.http.post<WikiAnswer>("/wiki/question", {
      ...
      ...(opts.maxEvidenceDepth !== undefined ? { max_evidence_depth: opts.maxEvidenceDepth } : {}),
    });
  }
   ...
   */
  public async getEntity(opts: GetEntityOptions): Promise<{
    entity: WikiEntity;
    neighbors?: Array<{ relation: WikiRelation; entity: WikiEntity }>;
  }> {
    return this.http.get(`/wiki/entities/${encodeURIComponent(opts.entityId)}`, {
      query: {
        tenantId: opts.tenantId,
   ...
   */
  public async getRelated(opts: GetRelatedOptions): Promise<{
    entity_id: string;
    relationships: Array<{ relation: WikiRelation; entity: WikiEntity }>;
  }> {
    return this.http.get(`/wiki/entities/${encodeURIComponent(opts.entityId)}/relationships`, {
      query: {
        tenantId: opts.tenantId,
  ...
  public async getPage(opts: GetPageOptions): Promise<WikiPage> {
    return this.http.get<WikiPage>(`/memory/pages/${encodeURIComponent(opts.slugOrId)}`, {
