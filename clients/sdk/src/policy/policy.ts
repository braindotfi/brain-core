...
export class PolicyModule {
  ...
  public async getActive(opts: GetActiveOptions): Promise<Policy> {
    return this.http.get<Policy>(`/policy/${encodeURIComponent(opts.tenantId)}`);
  }
  ...
  public async compose(opts: ComposeOptions): Promise<{
    ...
    return this.http.post(`/policy/${encodeURIComponent(opts.tenantId)}/compose`, opts.content);
  }
  ...
  public async sign(opts: SignOptions): Promise<Policy> {
    return this.http.post<Policy>(`/policy/${encodeURIComponent(opts.tenantId)}/sign`, {
  ...
  public async simulate(opts: SimulateOptions): Promise<PolicyDecision> {
    return this.http.post<PolicyDecision>(`/policy/${encodeURIComponent(opts.tenantId)}/simulate`, {
      action: opts.action,
