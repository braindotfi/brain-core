...
-- The Collections, Reconciliation, and Cash Forecast scanners share the ledger
-- worker pool for cross-tenant enumeration only. They need ledger and cooldown reads, then
