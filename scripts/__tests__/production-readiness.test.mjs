...
test("production with all baseline env set: every fence green (non-risk sections)", () => {
  const r = runWithEnv({
    ...
    BRAIN_RAW_WORKER_DB_URL: "postgres://y",
    BRAIN_CANONICAL_PROJECTOR_DB_URL: "postgres://y",
    BRAIN_LEDGER_PROJECTOR_DB_URL: "postgres://y",
    BRAIN_EXECUTION_WORKER_DB_URL: "postgres://y",
    BRAIN_AUDIT_VERIFIER_DB_URL: "postgres://y",
    BRAIN_AUDIT_PUBLISHER_DB_URL: "postgres://y",
    BRAIN_RESOLVER_DB_URL: "postgres://y",
    BRAIN_TENANT_DELETION_DB_URL: "postgres://y",
