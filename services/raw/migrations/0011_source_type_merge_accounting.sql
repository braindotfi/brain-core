-- Brain Raw -- admit the scaffolded 'merge_accounting' connector type.
...
ALTER TABLE raw_artifacts
  ...
  CHECK (source_type IN ('plaid','stripe','netsuite','email_inbound','csv_upload','pdf_upload','alchemy_wallet','eth_address','merge_accounting','agent_contributed','wiki_annotation','other'));
...
ALTER TABLE raw_sources
  ...
  CHECK (type IN ('plaid','stripe','netsuite','email_inbound','csv_upload','pdf_upload','alchemy_wallet','eth_address','merge_accounting'));
